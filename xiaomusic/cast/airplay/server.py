...
from xiaomusic.cast.airplay.audio_stream import AudioStreamServer
...
class AirPlayServer:
    ...
    def __init__(self, hostname: str, device_name: str = "XiaoMusic", shared_zeroconf=None, speaker_hardware: str = ""):
    ...
    def _handle_announce(self, sock: socket.socket, headers: dict, body: bytes, cseq: str):
        ...
        if aes_key and aes_iv:
            if aes_key_type == "rsa":
                ...
                # 解密 FairPlay AES 密钥
                try:
                    from xiaomusic.cast.airplay.playfair import FairPlayAES
