...
from xiaomusic.cast.speaker_adapter import SpeakerController
from xiaomusic.cast.dlna.cover import resolve_default_cover_url
from xiaomusic.cast.dlna.xmlsafe import safe_fromstring
...
class DLNARenderer:
    ...
    async def notify_state_change(self):
        ...
        if not self.event_manager:
            return
        try:
            from xiaomusic.cast.dlna.eventing import build_last_change_event
